...
public class MergeOverlappingIntervalsREPEAT {

    public static void main(String[] args) {
        int[][] intervals = {{1, 2}, {3, 5}, {4, 7}, {6, 8}, {9, 10}};
        MergeOverlappingIntervalsREPEAT mergeOverlappingIntervalsREPEAT = new MergeOverlappingIntervalsREPEAT();
        mergeOverlappingIntervalsREPEAT.mergeOverlappingIntervals(intervals);
    }
