...
public class MinimumPassesOfMatrixREPEAT {
    ...
    public static void main(String[] args) {
        ...
        MinimumPassesOfMatrixREPEAT minimumPassesOfMatrixREPEAT = new MinimumPassesOfMatrixREPEAT();
        minimumPassesOfMatrixREPEAT.minimumPassesOfMatrix(matrix);
    }
...
//
//    private int convertNegative(int[][] matrix) {
//        Queue<NodeInfo> nextPassQueue = getAllPositivePositions(matrix);
//        Queue<NodeInfo> currentPassQueue = new LinkedList<>();
//        int passes = 0;
//
...
//                NodeInfo current = currentPassQueue.poll();
...
//                    if (value < 0) {
//                        matrix[row][col] = -1 * value;
//                        nextPassQueue.add(new NodeInfo(row, col));
//                    }
//                }
//            }
//            passes++;
