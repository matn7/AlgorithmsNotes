...
public class SearchForRangeREPEAT {
...
//        int[] finalRange = {-1, -1};
//
//        alteredBinarySearch(array, target, 0, array.length - 1, finalRange, true); // left extreme
//        alteredBinarySearch(array, target, 0, array.length - 1, finalRange, false); // right extreme
//
//        return finalRange;
//    }
//
