...
public class DetectArbitrageREPEAT {
    ...
    public static void main(String[] args) {
        ...
        DetectArbitrageREPEAT detectArbitrageREPEAT = new DetectArbitrageREPEAT();
        boolean result = detectArbitrageREPEAT.detectArbitrage(exchangeRates);
