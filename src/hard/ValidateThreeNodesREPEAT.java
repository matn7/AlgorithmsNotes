...
public class ValidateThreeNodesREPEAT {
    ...
    public static void main(String[] args) {
        ...
        ValidateThreeNodesREPEAT validateThreeNodesREPEAT = new ValidateThreeNodesREPEAT();
        boolean result = validateThreeNodesREPEAT.validateThreeNodes(tree, tree.left, tree.left.right.left);
