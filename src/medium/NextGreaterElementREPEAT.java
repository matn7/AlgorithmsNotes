...
public class NextGreaterElementREPEAT {

    public static void main(String[] args) {
        int[] array = {2, 5, -3, -4, 6, 7, 2};

        NextGreaterElementREPEAT nextGreaterElementREPEAT = new NextGreaterElementREPEAT();
        nextGreaterElementREPEAT.nextGreaterElement(array);
    }
